...
public class OkHttpClient
    ...
    static final List<Protocol> DEFAULT_PROTOCOLS = Util
    ...
    static {
        Internal.instance = new Internal() {
            @Override
            public void addLenient(Headers.Builder builder,
                                   String line) {
            ...
            @Override
            public RealConnection get(ConnectionPool pool,
                                      Address address, StreamAllocation streamAllocation,
                                      Route route) {
            ...
            @Override
            public Socket deduplicate(ConnectionPool pool,
                                      Address address, StreamAllocation streamAllocation) {
                return pool.deduplicate(address, streamAllocation);
            }

            @Override
            public void put(ConnectionPool pool,
                            RealConnection connection) {
                pool.put(connection);
            }
            ...
            @Override
            public boolean isInvalidHttpUrlHost(
            ...
            @Override
            public @Nullable
            IOException timeoutExit(Call call,
                                    @Nullable IOException e) {
                return ((RealCall) call).timeoutExit(e);
            }

            @Override
            public Call newWebSocketCall(OkHttpClient client,
     ...
     * 支持协议、任务分发器（其内部包含一个线程池，执行异步请求）、连接池(其内部包含一个线程池，维护connection)、
     * 连接/读/写超时时长等信息。
     *
     * @param builder
     */
    ...
    private static SSLSocketFactory newSslSocketFactory(
        ...
        try {
            ...
            throw assertionError("No System TLS",
                    e); // The system has no TLS. Just give up.
        }
    }
    ...
    public WebSocket newWebSocket(Request request,
        ...
        RealWebSocket webSocket = new RealWebSocket(request, listener,
                new Random(), pingInterval);
    ...
    public static final class Builder {
        ...
        public Builder callTimeout(Duration duration) {
            callTimeout = checkDuration("timeout", duration.toMillis(),
        ...
        public Builder connectTimeout(Duration duration) {
            connectTimeout = checkDuration("timeout", duration.toMillis(),
                    TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public Builder readTimeout(Duration duration) {
            readTimeout = checkDuration("timeout", duration.toMillis(),
                    TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public Builder writeTimeout(Duration duration) {
            writeTimeout = checkDuration("timeout", duration.toMillis(),
                    TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public Builder pingInterval(Duration duration) {
            pingInterval = checkDuration("timeout", duration.toMillis(),
                    TimeUnit.MILLISECONDS);
            return this;
        }
        ...
        public Builder sslSocketFactory(SSLSocketFactory sslSocketFactory) {
            ...
            this.certificateChainCleaner = Platform.get()
        ...
        public Builder protocols(List<Protocol> protocols) {
            ...
            if (!protocols.contains(Protocol.H2_PRIOR_KNOWLEDGE) && !protocols
         ...
         * @see EventListener for semantics and restrictions on listener implementations.
         */
        public Builder eventListenerFactory(
                EventListener.Factory eventListenerFactory) {
